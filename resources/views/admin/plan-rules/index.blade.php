...
<div class="max-w-3xl space-y-5">
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-xl px-4 py-3 text-sm text-blue-700">
        Definí cuántas veces por mes puede asistir un paciente a cada tipo de grupo según su <strong>plan contratado</strong> (descenso, mantenimiento o mantenimiento pleno).<br>
