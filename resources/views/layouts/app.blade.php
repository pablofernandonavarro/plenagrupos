...
<head>
    ...
    <meta property="og:site_name" content="Plena Grupos">
    <meta property="og:type" content="website">
    <meta property="og:title" content="@yield('og_title', 'Plena Grupos')">
    <meta property="og:description" content="@yield('og_description', 'Programa grupal de bienestar y descenso de peso.')">
...
<body class="bg-gray-50 min-h-screen">
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="hidden sm:flex items-center gap-4">
                    @if(auth()->user()->isAdmin())
                        ...
                        <a href="{{ route('admin.adherence.index') }}" class="text-sm text-gray-300 transition"
                           onmouseover="this.style.color='#09cda6'" onmouseout="this.style.color='#d1d5db'">Adherencia</a>
                        ...
                        <a href="{{ route('admin.whatsapp.index') }}" class="text-sm text-gray-300 transition"
                           onmouseover="this.style.color='#09cda6'" onmouseout="this.style.color='#d1d5db'">WhatsApp</a>
        ...
        <div id="mobile-menu" class="sm:hidden hidden border-t border-white/10" style="background-color: #1e1d35;">
            <div class="px-4 py-3 space-y-1">
                @if(auth()->user()->isAdmin())
                    ...
                    <a href="{{ route('admin.adherence.index') }}" class="block py-2 px-3 rounded-lg text-sm text-gray-300 hover:bg-white/10 hover:text-white transition">Adherencia</a>
    ...
    <script>
        ...
        // Usuarios / Turnos dropdowns (abrir uno cierra el otro)
        ...
        const navMenus = [usuariosMenu, turnosMenu].filter(Boolean);
        ...
        if (usuariosBtn) {
            usuariosBtn.addEventListener('click', (e) => {
                e.stopPropagation();
                const willOpen = usuariosMenu.classList.contains('hidden');
                closeNavMenus();
                if (willOpen) usuariosMenu.classList.remove('hidden');
            });
        }
        if (turnosBtn) {
            turnosBtn.addEventListener('click', (e) => {
                e.stopPropagation();
                const willOpen = turnosMenu.classList.contains('hidden');
                closeNavMenus();
                if (willOpen) turnosMenu.classList.remove('hidden');
            });
        }
        if (navMenus.length) {
