...
<div class="space-y-6">
            ...
            <div class="p-4 space-y-2">
                @forelse($group->coordinators as $coord)
                    <div class="flex justify-between items-center py-1">
                        ...
                        <form action="{{ route('coordinator.groups.coordinators.remove', $group) }}" method="POST"
                ...
                @endforelse
                <form action="{{ route('coordinator.groups.coordinators.add', $group) }}" method="POST" class="flex gap-2 pt-2 border-t">
                    @csrf
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="px-5 py-4 border-b border-gray-100 flex justify-between items-center">
            ...
            <form action="{{ route('coordinator.groups.patients.add', $group) }}" method="POST" class="flex gap-2" id="add-patient-form">
                @csrf
                <div class="relative">
        ...
        <div id="patients-list" class="divide-y divide-gray-50">
            @forelse($group->patientsAll->where('belonging_group_id', $group->id) as $patient)
                ...
                <div class="px-5 py-3 flex justify-between items-center gap-2">
                    ...
                    <form action="{{ route('coordinator.groups.patients.remove', $group) }}" method="POST">
                        @csrf @method('DELETE')
    ...
    {{-- Iniciar / Finalizar sesión — el coordinador solo maneja la sesión de hoy; finalizar el programa es acción de admin --}}
...
const removeUrl      = '{{ route('coordinator.groups.patients.remove', $group) }}';
